...
- Small rectangles (1×2, 2×3)
- Large rectangles (13×13)
- Prime dimensions
- Perfect square dimensions
- Known special cases (11×13)
...
1. **Game Theory with Backtracking**
   ...
   function tilingRectangle(n, m):
       ...
       return result
   ```
   Time: O(k^(n×m)), Space: O(n×m) where k is average choices per state
...
Step 1: Place 2×2 square
[▣▣][ ]
[▣▣][ ]

Step 2: Place 1×1 squares
[▣▣][■]
[▣▣][■]
...
1. Initial strategy:
   Try 2×2 square at (0,0)
   
2. After first move:
   Need to cover remaining 1×2 strip
...
2. **Pruning**:
   - Stop if current count ≥ best found
